...
@app.route('/user_sel')
def user_sel():
    # explanations = load_explanations('explainations.txt')
...
def generate():
    ...
    print("Random Explanation:", random_explanation) 
...
def generate_deed_of_partnership(partners, partnership_details, witnesses):
    pdf = PDF()
    pdf.add_page()
